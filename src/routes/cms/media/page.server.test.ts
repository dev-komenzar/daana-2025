...
describe('cms/media +page.server load', () => {
	...
	test('data.items に thumbUrl が含まれる (buildPbFileUrl を経由する)', async () => {
		...
		expect(items[0].thumbUrl).toBe('https://pub.example.com/api/files/col_media/rec1/test.jpg?thumb=200x200')
