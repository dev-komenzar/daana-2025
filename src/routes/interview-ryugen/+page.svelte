...
<section class="container">
	...
	<div class="full-content put-image-left">
		...
		<div class="description-fourth space-description">
			<p
				class="body space-top"
				use:floatUp
			>
...
.image-wrapper.fourth + .description-fourth {
	margin-top: 70px;
}
