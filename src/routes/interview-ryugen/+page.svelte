...
<section class="container">
	...
	<div class="full-content put-image-right">
		...
		<div
			class="image-wrapper-first content"
			use:floatUp
		>
			<EnhancedImage
				src={p.imageUrl}
	...
	<div class="wide-content">
		<h3
			class="interview-subheading"
			use:floatUp
		>
			2500年の「智の体系」を、現代へ
		</h3>
		<p
			class="interview-body"
			use:floatUp
		>
			問い：なぜ今、仏教なのでしょうか。
		</p>
		...
		<p
			class="interview-body space-top"
			use:floatUp
		>
			問い：その「構造」とは何でしょうか。
		</p>
	...
	<div class="full-content put-image-left">
		<div
			class="image-wrapper-second content"
			use:floatUp
		>
			<EnhancedImage
				src={PhotoSecond}
	...
	<div class="full-content put-image-right">
		...
		<div
			class="image-wrapper-third content"
			use:floatUp
		>
			<EnhancedImage
				src={PhotoThird}
	...
	<div class="full-content put-image-left">
		<div
			class="image-wrapper-fourth content"
			use:floatUp
		>
			<EnhancedImage
				src={PhotoFourth}
